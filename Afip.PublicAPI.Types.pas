...
{$ENDREGION}
  ...
  TIntegersPair = TPair<Integer, Integer>;
...
{$REGION 'IPersona_Afip'}
  IPersona_Afip = interface
    ...
    function GetCategoriasMonotributo: TArray<TIntegersPair>;
    ...
    property CategoriasMonotributo: TArray<TIntegersPair> read GetCategoriasMonotributo;
...
{$REGION 'TPersona_Afip'}
  ...
  strict private
    FCategoriasMonotributo: TArray<TIntegersPair>;
    ...
    procedure SetCategoriasMonotributo(const Value: TArray<TIntegersPair>);
  public
    ...
    property CategoriasMonotributo: TArray<TIntegersPair> read GetCategoriasMonotributo write SetCategoriasMonotributo;
...
function TPersona_Afip.GetCategoriasMonotributo: TArray<TIntegersPair>;
begin
...
procedure TPersona_Afip.SetCategoriasMonotributo(const Value: TArray <TIntegersPair>);
begin
